...
!***********************************************************************
  !use crest_parameters,only:wp,bohr,stdout, aatoau, autoaa
...
subroutine calc_thermo_from_hess(mol, hess, pr, nt)
type(coord), intent(inout) :: mol
integer :: nat3
integer :: io
logical :: pr
real(wp) :: ithr, fscal, sthr, temps(nt)
integer, intent(in) :: nt 
real(wp) :: et(nt),ht(nt),gt(nt),stot(nt)
